...
int main(){
 ...
 if(!acts||acts->bytes!=activation_count*2||!xhat||xhat->bytes!=activation_count*4||xhat->dtype!=mgt::A100ArenaDtype::kFp32||!masks||masks->bytes!=mask_bytes||!dz||dz->bytes!=12500ULL*1024*2*2||!scratch||scratch->bytes!=12500ULL*1024*8)return 2;
