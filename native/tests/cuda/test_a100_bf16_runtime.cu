...
int main(){
 ...
 mgt_cuda::A100Bf16RuntimeCreateInfo info{};info.arena_info=arena_info;info.arena_info.profile=&profile;info.device_id=0;info.rank=0;info.world=1;info.execution_profile=&profile;info.profile_use=mgt::A100ExecutionProfileUse::kCandidateForTuner;
