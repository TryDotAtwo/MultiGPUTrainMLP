...
shift 4
"$binary" --output-dir "$run_dir" --steps 1 --device-id 0 --world-size 1 --global-rank 0 --local-rank 0 --batch-size 8 --k-min 2 --k-max 5 --hd1 7 --hd2 4 --write-artifacts 1 --backward-profile 1 "$@"
