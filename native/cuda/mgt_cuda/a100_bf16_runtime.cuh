...
const Bf16LinearTrainOpsPlan* A100Bf16RuntimeWeightLinearPlan(const A100Bf16Runtime* runtime);
cudaStream_t A100Bf16RuntimeWeightStream(A100Bf16Runtime* runtime);
cudaEvent_t A100Bf16RuntimeDzReadyEvent(A100Bf16Runtime* runtime, std::uint32_t slot);
cudaEvent_t A100Bf16RuntimeDzReuseEvent(A100Bf16Runtime* runtime, std::uint32_t slot);
mgt::A100DwDxSchedule A100Bf16RuntimeDwDxSchedule(const A100Bf16Runtime* runtime);
